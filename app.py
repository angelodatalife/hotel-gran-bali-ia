...
def mostrar_pantalla_inicio():
    ...
    st.markdown(
        """
        <div style="position: absolute; top: -10px; left: -20px; z-index: 999;">
            <h2 style="color: white; margin: 0; line-height: 1.2; text-shadow: 2px 2px 4px rgba(0,0,0,0.5); font-size: 4rem;">
                Check it Out! <br>
    ...
    with col2:
        ...
        st.markdown(
            """
            <h3 style='text-align: center; color: #1E88E5; margin-bottom: 200px;'>
                Cargar PMS ⬇️
            </h3>
            """,
            unsafe_allow_html=True
